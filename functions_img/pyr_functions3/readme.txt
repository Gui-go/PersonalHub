...
curl -X POST http://localhost:8080/   -H "Content-Type: application/json"   -d '{"data": {"columns": ["dep_y", "ind_x1", "ind_x2"], "rows": [[3, 2, 3], [4, 5, 6], [7, 9, 9]]}}'

                                                                                          {"columns":["dep_var","ind_var1","ind_var2","ind_var3"],"rows":["[1,2,1,0.5]","[3,6,5,1.5]","[5,10,9,2.5]","[2,4,3,1]","[4,8,7,2]"]}


                                                                                          ["[1,2,1,0.5]","[3,6,5,1.5]","[5,10,9,2.5]","[2,4,3,1]","[4,8,7,2]"]
