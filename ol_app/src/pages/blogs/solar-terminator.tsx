...
import * as d3 from 'd3-geo'; // d3-geo provides d3.GeoSphere
...
declare global {
  interface HTMLCanvasElement {
    ...
    nightPath?: GeoJSON.GeometryObject; // This is correct for general GeoJSON geometry
  }
}
...
const SolarTerminator = () => {
  ...
  const renderMap = useCallback(async () => {
    ...
    try {
      ...
      // FIX: Use d3.GeoSphere type from d3-geo itself
      ...
      const land = topojson.feature(world, world.objects.land) as GeoJSON.FeatureCollection<GeoJSON.Polygon>;
      ...
      // Draw sphere outline using the correctly typed sphere
  ...
  useEffect(() => {
    let mapInterval: ReturnType<typeof setTimeout> | undefined;
    let clockInterval: ReturnType<typeof setTimeout> | undefined;
