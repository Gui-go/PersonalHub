...
const AgMSdiscovery = ({ content }) => {
    const navigate = useNavigate();

    // Extract the virtual-guigo agent data
    const pageData = content.aiagents.find(agent => agent.id === 'migration-dynamics-discovery') || {};

    // const virtualguigo_configId = process.env.VIRTUALGUIGO_CONFIG_ID; 
    const migrationDynamics_configId = process.env.REACT_APP_MIGRATIONDYNAMICS_CONFIG_ID;

    useEffect(() => {
        const script = document.createElement('script');
        script.src = "https://cloud.google.com/ai/gen-app-builder/client?hl=pt_BR"; //load language dynamically TODO: make it dynamic
        script.async = true;
...
//             This is a placeholder for Agent MSdiscovery. Add specific content about this agent here.
//           </p>
//         </div>
//       </div>
//     </div>
